...
public class JavaObjClientMain extends JFrame {
	...
	private ImageIcon userImage = new ImageIcon("images/userBasicImage-crop.png");
	...
	class Myaction implements ActionListener // 내부클래스로 액션 이벤트 처리 클래스
	{
		...
		public void actionPerformed(ActionEvent e) {
			...
			JavaObjClientMainHome view = new JavaObjClientMainHome(userImage, username, ip_addr, port_no);
			setVisible(false);
		}
	}
}
